...
const Section = ({
    className , id , crosses , crossessoffset , customPaddings ,  children}) => {
  return (
    <div
      id={id}
      className={`
      ...
      >
        ...
        crosses && (
            <>
                      <div className={`hidden absolute top-0 left-7.5 right-7.5 h-0.25 bg-strok-1 ${crossessoffset && crossessoffset} pointer-events-none lg:block xl:left-10 right-10`} />
