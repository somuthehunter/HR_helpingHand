...
SECRET_KEY = 'django-insecure-mxr$u18mre7v!zlfmha)=z36l%@e2=cig_@d6nb531&2e6^$cl'
...
# If you're using session-based authentication (e.g., Django Auth)
...
AUTH_USER_MODEL = "resume_hr_side.CustomUser"
